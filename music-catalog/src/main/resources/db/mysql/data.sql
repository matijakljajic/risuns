...
INSERT INTO track (id, album_id, title, track_no, is_explicit) VALUES
  (1, 1, 'Feather', 1, 0),
  (2, 1, 'Luv Sic Part 3', 2, 0),
  (3, 1, 'Sky Is Tumbling', 5, 0),
  (4, 2, 'Arurian Dance', 1, 0),
  (5, 2, 'Another Reflection', 3, 0),
  (6, 3, '81Summer', 2, 0),
  (7, 3, 'Homeward Journey', 5, 0),
  (8, 4, 'Workinonit', 1, 1),
  (9, 4, 'Last Donut of the Night', 31, 0),
  (10, 4, 'Airworks', 5, 1);
...
INSERT INTO users (id, username, email, password_hash, role, enabled, display_name, notify_on_message) VALUES
  (1, 'matija', 'matija@example.rs', '$2a$10$WGzIJ0FB/1ccOV8cdOwtV.I6vWhBoTjEfagoTFcEzciCwgmjavMfe', 'USER', 1, 'Matija', 1),
  (2, 'jelena', 'jelena@example.rs', '$2a$10$nM.20N9Wn9jXdTYAiJuMguYWt.ZVi4w41bqECoEdu4Zdu7fFZkf32', 'USER', 1, 'Jelena', 1),
  (3, 'nikola', 'nikola@example.rs', '$2a$10$Lb0lw18kBYliFlmf07w1duhw2mXGCVKqKd0qvgbCX8Bw5OxBCzjRK', 'USER', 1, 'Nikola', 0),
  (4, 'admin',  'admin@example.rs',  '$2a$10$KZK0GH0wawI7KqNnTA8HpOmk88buK5J/XcG5hc4uVZoerpKKKbF1S', 'ADMIN', 1, 'Admin', 0);

INSERT INTO message (id, sender_id, receiver_id, sent_at, content) VALUES
  (1, 2, 1, CURRENT_TIMESTAMP - INTERVAL 4 HOUR, 'Ćao Matija, slušaš li i dalje ''Feather''?'),
  (2, 1, 2, CURRENT_TIMESTAMP - INTERVAL 3 HOUR, 'Naravno, ta pesma mi uvek popravi dan.'),
  (3, 3, 1, CURRENT_TIMESTAMP - INTERVAL 2 HOUR, 'Ajde podeli novi plejlist kad stigneš.'),
  (4, 1, 3, CURRENT_TIMESTAMP - INTERVAL 90 MINUTE, 'Stiže večeras, spremi slušalice!');

INSERT INTO playlist (id, user_id, name, created_at, is_public) VALUES
  (1, 1, 'Vožnja kroz grad', CURRENT_TIMESTAMP - INTERVAL 2 DAY, 0),
  (2, 1, 'Fokus na kod', CURRENT_TIMESTAMP - INTERVAL 26 HOUR, 1),
  (3, 2, 'Jutarnja kafa', CURRENT_TIMESTAMP - INTERVAL 6 HOUR, 1),
  (4, 3, 'Kasnonoćni ritmovi', CURRENT_TIMESTAMP - INTERVAL 4 HOUR, 1);
